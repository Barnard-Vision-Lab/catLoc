...
task.stair.threshEstimates = zeros(task.stair.nSeparateConds,task.stair.nPerCond);
task.stair.threshSDs = zeros(task.stair.nSeparateConds,task.stair.nPerCond);
task.stair.meanThreshs = zeros(task.stair.nSeparateConds,1);
for sti = 1:task.stair.nSeparateConds
    for ssi = 1:task.stair.nPerCond
        if task.stairType == 1
